...
public class SwerveUtil {
    public static double[] optimizeModule(double currentAngle, double desiredAngle, double speed) {
        ...
        // Drive speed of module proportional to its closeness to desired angle to prevent slippage at high speeds
        optimizedModule[1] *= Math.abs(Math.cos(currentAngle - optimizedModule[0]));
